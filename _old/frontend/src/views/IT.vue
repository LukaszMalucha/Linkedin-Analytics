...
<div class="row plain-element">
  <div class="row header">
          <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 text-left plain-element">
              <img src="https://linkedin-analytics.s3-eu-west-1.amazonaws.com/static/img/insights/it-medium.jpg" class="img responsive img-header">
          </div>
              ...
              <div class="row plain-element no-margin-bottom">
                  <div class="card insights-card insights-card-narrow-left" id="establishedCard">
                      <div class="card-header">
                          <img src="https://linkedin-analytics.s3-eu-west-1.amazonaws.com/static/img/insights/it-small.jpg" class="img-responsive">
...
export default {
  ...
  created() {
    this.getSectorData();
    document.title = "Linkedin Analytics - IT Companies";
  }
};
